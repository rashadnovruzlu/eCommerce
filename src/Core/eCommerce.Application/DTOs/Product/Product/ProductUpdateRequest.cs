...
#nullable disable
    public class ProductUpdateRequest : BaseDTO, IMapTo<Product>
    {
        ...
        public ICollection<ProductTranslationUpdateRequest> ProductTranslations { get; set; }
        public int[] DeletedProductTranslations { get; set; }
